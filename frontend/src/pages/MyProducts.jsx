...
const MyProducts = () => {
    ...
    useEffect(() => {
        const fetchProducts = async() => {
            try {
                const res =await axios.post("https://campus-market-b0vp.onrender.com/api/v1/product/myProducts", {userId});
    ...
    const handleDelete = async(productId) => {
        ...
        try {
            await axios.post(`https://campus-market-b0vp.onrender.com/api/v1/product/deleteProduct`,{productId});
